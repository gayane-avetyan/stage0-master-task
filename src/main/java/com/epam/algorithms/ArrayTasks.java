...
public class ArrayTasks {
    ...
    public int[][] sortRaggedArray(int[][] arr) {
        ...
        {
            for (int j = 0; j < arrLengths.length - 1; j++)
            {
                if (arrLengths[j] < arrLengths[j + 1]) {
                    int temp = arrLengths[j];
                    arrLengths[j] = arrLengths[j + 1];
                    arrLengths[j + 1] = temp;
                }
            }
